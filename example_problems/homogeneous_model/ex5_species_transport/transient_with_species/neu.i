...
[AuxKernels]
  ...
  [update_ad_f_U235]
    ...
    variable = ad_U235
    coupled_variables = 'T_salt void_f'
    expression = '9.692763E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
  ...
  [update_ad_f_U238]
    ...
    variable = ad_U238
    coupled_variables = 'T_salt void_f'
    expression = '1.967924E-04 *(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_Be9]
    type = ParsedAux
    ...
    variable = ad_Be9
    coupled_variables = 'T_salt void_f'
    expression = '9.496943E-03*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_Li7]
    type = ParsedAux
    ...
    variable = ad_Li7
    coupled_variables = 'T_salt void_f'
    expression = '2.121311E-02 *(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_F9]
    type = ParsedAux
    ...
    variable = ad_F9
    coupled_variables = 'T_salt void_f'
    expression = '4.790899E-02*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_Zr90]
    type = ParsedAux
    ...
    variable = ad_Zr90
    coupled_variables = 'T_salt void_f'
    expression = '8.395505E-04*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_Zr91]
    type = ParsedAux
    ...
    variable = ad_Zr91
    coupled_variables = 'T_salt void_f'
    expression = '1.830855E-04*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_Zr92]
    type = ParsedAux
    ...
    variable = ad_Zr92
    coupled_variables = 'T_salt void_f'
    expression = '2.798495E-04*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_Zr94]
    type = ParsedAux
    ...
    variable = ad_Zr94
    coupled_variables = 'T_salt void_f'
    expression = '2.836027E-04*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_f_Zr96]
    type = ParsedAux
    ...
    variable = ad_Zr96
    coupled_variables = 'T_salt void_f'
    expression = '4.568967E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_U235]
    type = ParsedAux
    ...
    variable = ad_U235
    coupled_variables = 'T_salt void_f'
    expression = '2.159856E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_U238]
    type = ParsedAux
    ...
    variable = ad_U238
    coupled_variables = 'T_salt void_f'
    expression = '4.385162E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_Be9]
    type = ParsedAux
    ...
    variable = ad_Be9
    coupled_variables = 'T_salt void_f'
    expression = '2.116221E-03*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)*1.1'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_Li7]
    type = ParsedAux
    ...
    variable = ad_Li7
    coupled_variables = 'T_salt void_f'
    expression = '4.726958E-03*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_F9]
    type = ParsedAux
    ...
    variable = ad_F9
    coupled_variables = 'T_salt void_f'
    expression = '1.067565E-02*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_Zr90]
    type = ParsedAux
    ...
    variable = ad_Zr90
    coupled_variables = 'T_salt void_f'
    expression = '1.870786E-04*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_Zr91]
    type = ParsedAux
    ...
    variable = ad_Zr91
    coupled_variables = 'T_salt void_f'
    expression = '4.079728E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_Zr92]
    type = ParsedAux
    ...
    variable = ad_Zr92
    coupled_variables = 'T_salt void_f'
    expression = '6.235937E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_c_Zr94]
    type = ParsedAux
    ...
    variable = ad_Zr94
    coupled_variables = 'T_salt void_f'
    expression = '6.319571E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
  [update_ad_Zr96]
    type = ParsedAux
    ...
    variable = ad_Zr96
    coupled_variables = 'T_salt void_f'
    expression = '1.018111E-05*(1.0-0.4798*(T_salt-${T_Salt_initial})/${Salt_Density_initial})*(1.-void_f)'
    execute_on = 'INITIAL timestep_end'
  []
[]
# ==============================================================================
...
[UserObjects]
  ...
  [auxvar_solution_s1]
    ...
    folder = '../steady_with_species'
    var = 'vel_x  vel_y  T_salt  void_f T_solid  c1  c2  c3  c4  c5  c6
           ad_C12  ad_U235 ad_U238 ad_Be9  ad_Li7  ad_F9
           ad_Zr90 ad_Zr91 ad_Zr92 ad_Zr94 ad_Zr96'
    loading_var = 'vel_x  vel_y  T_salt  void_f T_solid  c1  c2  c3  c4  c5  c6
           ad_C12  ad_U235 ad_U238 ad_Be9  ad_Li7  ad_F9
           ad_Zr90 ad_Zr91 ad_Zr92 ad_Zr94 ad_Zr96'
    writing = false
    execute_on = 'INITIAL'
...
# ==============================================================================
[Outputs]
  file_base = msre_neutronics_tr_s2_out
  exodus = true
  csv = true
  perf_graph = true
