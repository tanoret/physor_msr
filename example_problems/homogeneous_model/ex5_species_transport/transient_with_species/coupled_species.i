...
[Mesh]
  ...
  [fmg]
    ...
    file = '../steady_with_species/msre_neutronics_ss_s2_out_flow_dnp0_coupled_species0.e'
...
[Variables]
  [Br91_f]
    ...
    initial_from_file_var = Br91_f
    block = ${fluid_blocks}
  []
  [Br91_g]
    type = MooseVariableFVReal
    initial_from_file_var = Br91_g
    block = ${fluid_blocks}
  []
  [Kr91_f]
    type = MooseVariableFVReal
    initial_from_file_var = Kr91_f
    block = ${fluid_blocks}
  []
  [Kr91_g]
    type = MooseVariableFVReal
    initial_from_file_var = Kr91_g
    block = ${fluid_blocks}
  []
  [Rb91_f]
    type = MooseVariableFVReal
    initial_from_file_var = Rb91_f
    block = ${fluid_blocks}
  []
  [Rb91_g]
    type = MooseVariableFVReal
    initial_from_file_var = Rb91_g
    block = ${fluid_blocks}
  []
  [Sr91_f]
    type = MooseVariableFVReal
    initial_from_file_var = Sr91_f
    block = ${fluid_blocks}
  []
  [Sr91_g]
    type = MooseVariableFVReal
    initial_from_file_var = Sr91_g
    block = ${fluid_blocks}
  []
  [Y91_f]
    type = MooseVariableFVReal
    initial_from_file_var = Y91_f
    block = ${fluid_blocks}
  []
  [Y91_g]
    type = MooseVariableFVReal
    initial_from_file_var = Y91_g
    block = ${fluid_blocks}
  []
  [Zr91_f]
    type = MooseVariableFVReal
    initial_from_file_var = Zr91_f
    block = ${fluid_blocks}
  []
  [Zr91_g]
    type = MooseVariableFVReal
    initial_from_file_var = Zr91_g
    block = ${fluid_blocks}
  []
[]
...
[AuxVariables]
  ...
  [mixing_length]
    type = MooseVariableFVReal
    initial_from_file_var = mixing_length
  []
  [superficial_vel_x]
  ...
  [interface_area_concentration_var]
    type = MooseVariableFVReal
    initial_from_file_var = interface_area_concentration_var
  []
[]
